<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
 ...
 <TR>
          <TD height=30 background=tema/img/fahne1.gif  width=129>
            <DIV align=center><IMG border=0 alt="" src="tema/img/spacer.gif" width=129 height=1>
<BR><STRONG><FONT color=#ffffff>Ýlanlarýnýz</FONT></STRONG></DIV>

</TD>
          <TD background=tema/img/bg_fahne.gif width="10%" 
          align=left>
            <DIV align=right><IMG border=0 alt="" src="tema/img/spacer.gif" width=1 height=2><BR></DIV></TD>
                    ...
                    <TR>
                      <TD>
                        ...
                        align=center>
                          <TBODY>
                          <TR>
                            <TD><IMG border=0 alt="" align=middle 
                              src="tema/img/teaser_02.gif" 
                              width=10 height=10>&nbsp;&nbsp; <FONT size=2><A 
                              href="?action=ana_form"><STRONG>Yeni 
                              Ýlan Oluþtur</STRONG></A></FONT></TD><!--- <td>&nbsp;&nbsp;&nbsp;</td>
	<form action="/index.php" action="GET">
	<input type="hidden" name="action" value="benimilanlar">
	<TD><div align="right"><font face="Verdana"><strong>Kayýtlý Ýlanlarýnýz Ýçerisinde Arayýnýz: </strong></font><input type="text" name="ara_val" value="" size="15" class="input" style="background-color: #ffffff; onFocus="this.style.backgroundColor='#ffff99'" onBlur="this.style.backgroundColor='#FFFFFF'"> <INPUT type="Submit" value="ARA" class="input2"></div></TD>
	</FORM> ---></TR></TBODY></TABLE>
                          ...
                          <TR>
                            <TD colSpan=4><!-- order start -->
                              ...
                              width="100%" align=right>
                                ...
                                <TD noWrap>&nbsp;<A 
                                href="?action=benimilanlar&amp;showstatus=2">Aktif Ýlanlar&#305;m</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="tema/img/flag_orange.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=benimilanlar&amp;showstatus=0">Kontrol 
                                Aþamasýndakiler</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="tema/img/flag_red.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=benimilanlar&amp;showstatus=1">Blokeliler</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="tema/img/flag_white.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=benimilanlar&amp;showstatus=3">S&uuml;resi 
                                Dolmuþlar</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="tema/img/award_star_bronze_1.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=benimilanlar&amp;showstatus=4">Vitrin 
                                Ýlanlar&#305;m</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="tema/img/flag_blue.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=benimilanlar">T&uuml;m 
                                Ýlanlar&#305;m</A></TD></TR></TBODY></TABLE><!-- order end --><BR></TD></TR>
                          <TR>
                            <TD colSpan=4>
                              <HR color=#c0c0c0 SIZE=1 width="100%" noShade>
                              ...
                              width="100%" align=center>
                                ...
                                height=11></TD>
                                <TD>&nbsp;&nbsp;<STRONG>Ýlan Kayýt ve Yayýnlanma 
                                Durumu</STRONG></TD>
                                <TD>&nbsp;&nbsp;</TD>
                                <TD>
                              ...
                              <!--  <FORM action=/index.php><INPUT 
                                ...
                                <TD noWrap><STRONG>Kayýtlý Ýlanlar Ý&ccedil;inde Ara: 
                                </STRONG></TD>
...
$vt->sql('select id,uye_id , tarih,ilan_tipi_id,ilan_grup,il,ilce,koy,fiyat,birim,ilan_suresi,bas_tarihi,dosya_no,hit,onay from ilan_ticari  where uye_id = "'.$_SESSION["id"].'"  '.$onay.'  order by id '.temizle($_GET["sortorder"]).'   ')->sor();
					  $veriler = $vt->alHepsi();
					if( $vt->numRows()==0) {
						echo '<DIV align=center><BR><BR><STRONG>Kayýtlý Ýlan 
                              Bulunmamaktadýr.</STRONG></DIV>';
					}
...
echo $vt->alTek() ."&nbsp;&nbsp;";
 ...
 ?>                           
                                ...
                                Süresi: <STRONG><?php echo date("d-m-Y",strtotime($veri->bas_tarihi)); ?></STRONG> - 
                                <STRONG><?php						
...
<!-- 
                                ...
                                width=16 height=16></TD>
                                <TD><IMG border=0 alt="" 
                                src="tema/img/lock.gif" width=16 
                                height=16></TD>
                                <TD>&nbsp;&nbsp;<STRONG>


<A  href="?action=topilan&amp;oid=<?php echo $veri->id; ?>">Bu  ilani vitrinde yay&#305;nlayarak sat&#305;&#351;&#305;n&#305; veya 
                                kiralanmas&#305;n&#305; h&#305;zland&#305;rabilirsiniz.</A>
...
-->
                                ...
                                href="?action=eleman_ekle&amp;id=<?php echo $veri->id; ?>">Bu ilana Sat&#305;&#351; Temsilcisi eklemek için 
                                t&#305;klay&#305;n&#305;z</A></STRONG></FONT></TD></TR></TBODY></TABLE>
...
<?php if( $veri->onay ==4 or $veri->onay ==2)  { ?>
...
<TR>
                                ...
                                width=16 height=16></TD>
                                <TD><A 
                                href="?action=vitrin&amp;oid=<?php echo $veri->id; ?>">
<?php
if($veri->onay==2) { echo " &#304;lan&#305; Vitrin Yap "; }
if($veri->onay==4) { echo " &#304;lan&#305; Vitrinden &Ccedil;&#305;kar "; }
 ?>
</A></TD></TR>
...
<?php } ?>
 ...
 <?php       } ?>                    
                  ...
                  color=#cc0000>*</FONT> Ýlan Ýstatistiklerinin G&uuml;ncelleme 
                  S&uuml;resi 24 Saattir. 
