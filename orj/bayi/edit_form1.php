...
$vt->sql("update ilan_ticari set  `fiyat` = '".temizle($_POST["fiyat"])."', `birim` = '".temizle($_POST["fiyat_art"])."', `yapi_tipi` = '".temizle($_POST["yapitipi"])."', `yapi_durum` = '".temizle($_POST["yapidurum"])."', `kullanim_durumu` = '".temizle($_POST["kullandurum"])."', `metrekare` = '".temizle($_POST["metrekare"])."', `bulundugu_kat` = '".temizle($_POST["kat"])."', `bina_kat_sayisi` = '".temizle($_POST["kat2"])."', `yapim_yili` = '".temizle($_POST["yil"])."', `oda_sayi` = '".temizle($_POST["oda"])."', `salon_sayisi` = '".temizle($_POST["salonoda"])."', `yatak_odasi_sayisi` = '".temizle($_POST["yatakoda"])."', `banyo_sayisi` = '".temizle($_POST["banyo"])."', `isinma_tipi` = '".temizle($_POST["isitma"])."', `yakit_tipi` = '".temizle($_POST["yakittipi"])."', `balkon` = '".temizle($_POST["balkon"])."', `bahce` = '".temizle($_POST["bahce"])."', `adres` = '".temizle($_POST["adres"])."', `posta_kodu` = '".temizle($_POST["postakodu"])."', `il_ilce` = '".temizle($_POST["yer"])."', `aciklama` = '".temizle($_POST["aciklama"])."', `ilan_suresi` = '".temizle($_POST["sure"])."', `satis_tarihi` = '".temizle($_POST["kirasatis"])."' , kredi='".temizle($_POST["kredi"])."', dosya_no='".temizle($_POST["dosya_no"])."' ,gx='".temizle($_POST["x"])."', gy='".temizle($_POST["y"])."' ,onay='2'  where id= '".temizle($_GET["oid"])."'");
...
echo "<h3>Ýlan   D&uuml;zeltilmi&#351;tir.</h3>";
...
} else {echo "<h3>Ilan Kaydinda Hata Olustu . Hata Kodu EF1500.<br>Hata devam ederse Lütfen Site Yöneticisine Bildiriniz.</h3>"; }
		}
 ...
 $vt->sql('select * from ilan_ticari where id="'.temizle($_GET["oid"]).'" and uye_id="'.$_SESSION["id"].'"   ')->sor();
  if($vt->numRows() == 0) {echo "<h3>Sayfada Hata Olustu . Hata Kodu EF1100.<br>Hata devam ederse Lütfen Site Yöneticisine Bildiriniz.</h3>";};
 $veriler1 = $vt->alHepsi();
          ...
          <TD>
            <TABLE border=0 cellSpacing=0 cellPadding=0>
              ...
              <TR>
                ...
                <TD>&nbsp;&nbsp;&nbsp;</TD>
                <TD><SELECT class=input name=fiyat_art>
                <OPTION selected value=1 <?php if (!(strcmp(1, "$veri1->birim"))) {echo "selected=\"selected\"";} ?>>TL</OPTION>
                <OPTION value=2 <?php if (!(strcmp(2, "$veri1->birim"))) {echo "selected=\"selected\"";} ?>>Euro</OPTION>
                <OPTION value=3 <?php if (!(strcmp(3, "$veri1->birim"))) {echo "selected=\"selected\"";} ?>>USD</OPTION>
				<OPTION value=4 <?php if (!(strcmp(4, "$veri1->birim"))) {echo "selected=\"selected\"";} ?>>GBP</OPTION>
                </SELECT></TD>
                <TD>&nbsp;&nbsp;&nbsp;</TD>
 ...
 ?></TD></TR>
        ...
        <TR>
          ...
          <TD colSpan=2><INPUT 
            ...
            onkeypress="return numbersonly(this, event)" value="<?php echo $veri1->metrekare; ?>" size=10 maxLength=10> m&sup2;</TD></TR>
        ...
        <TR>
          ...
          <TD colSpan=2><SELECT style="WIDTH: 150px" class=input name=kat2>
            ...
            <OPTION value=1 <?php if (!(strcmp(100, "$veri1->bina_kat_sayisi"))) {echo "selected=\"selected\"";} ?>>M&uuml;stakil</OPTION>
            <OPTION value=1 <?php if (!(strcmp(101, "$veri1->bina_kat_sayisi"))) {echo "selected=\"selected\"";} ?>>Dubleks</OPTION>
            <OPTION value=1 <?php if (!(strcmp(102, "$veri1->bina_kat_sayisi"))) {echo "selected=\"selected\"";} ?>>Tripleks</OPTION>                                    
...
<OPTION value=98 <?php if (!(strcmp(98, "$veri1->bina_kat_sayisi"))) {echo "selected=\"selected\"";} ?>>98 Kat</OPTION><OPTION value=99 <?php if (!(strcmp(99, "$veri1->bina_kat_sayisi"))) {echo "selected=\"selected\"";} ?>>99               Kat</OPTION></SELECT> </TD></TR>
        ...
        <TR>
          ...
          <TD colSpan=2><SELECT style="WIDTH: 150px" class=input name=kat>
            ...
            <OPTION 
              value=100 <?php if (!(strcmp(100, "$veri1->bulundugu_kat"))) {echo "selected=\"selected\"";} ?>>Zemin Kat</OPTION><OPTION value=101 <?php if (!(strcmp(101, "$veri1->bulundugu_kat"))) {echo "selected=\"selected\"";} ?>>Bodrum Kat</OPTION>
            <OPTION value=102 <?php if (!(strcmp(102, "$veri1->bulundugu_kat"))) {echo "selected=\"selected\"";} ?>>Yarý Bodrum</OPTION>
            ...
            <OPTION value=106 <?php if (!(strcmp(106, "$veri1->bulundugu_kat"))) {echo "selected=\"selected\"";} ?>>Y&uuml;ksek               Giriþ Katý</OPTION>
            <OPTION value=107 <?php if (!(strcmp(107, "$veri1->bulundugu_kat"))) {echo "selected=\"selected\"";} ?>>Komplesi</OPTION>
            <OPTION 
              value=108 <?php if (!(strcmp(108, "$veri1->bulundugu_kat"))) {echo "selected=\"selected\"";} ?>>&Ccedil;atý Dubleksi</OPTION>
<OPTION 
              value=109 <?php if (!(strcmp(109, "$veri1->bulundugu_kat"))) {echo "selected=\"selected\"";} ?>>Dubleks</OPTION><OPTION value=110 <?php if (!(strcmp(110, "$veri1->bulundugu_kat"))) {echo "selected=\"selected\"";} ?>>Tripleks</OPTION>
...
<OPTION value=2005 <?php if (!(strcmp(2005, "$veri1->yapim_yili"))) {echo "selected=\"selected\"";} ?>>2005</OPTION><OPTION 
        ...
        <TR>
          ...
          <TD colSpan=2><SELECT style="WIDTH: 150px" class=input name=oda>
            <OPTION selected value=0 <?php if (!(strcmp(0, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>Bilgi Yok</OPTION>
            <OPTION value=1 <?php if (!(strcmp(1, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>1               Oda</OPTION>
            <OPTION value=2 <?php if (!(strcmp(2, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>2 Oda</OPTION>
            <OPTION value=3 <?php if (!(strcmp(3, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>3               Oda</OPTION>
            <OPTION value=4 <?php if (!(strcmp(4, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>4 Oda</OPTION>
            <OPTION value=5 <?php if (!(strcmp(5, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>5               Oda</OPTION>
<OPTION value=6 <?php if (!(strcmp(6, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>6 Oda</OPTION>
            <OPTION value=7 <?php if (!(strcmp(7, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>7               Oda</OPTION>
            <OPTION value=8 <?php if (!(strcmp(8, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>8 Oda</OPTION>
            <OPTION value=9 <?php if (!(strcmp(9, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>9               Oda</OPTION>
            <OPTION value=10 <?php if (!(strcmp(10, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>10 Oda</OPTION>
            <OPTION value=11 <?php if (!(strcmp(11, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>11               Oda</OPTION>
            <OPTION value=12 <?php if (!(strcmp(12, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>12 Oda</OPTION>
            <OPTION value=13 <?php if (!(strcmp(13, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>13               Oda</OPTION>
          <OPTION value=14 <?php if (!(strcmp(14, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>14 Oda</OPTION><OPTION value=15 <?php if (!(strcmp(15, "$veri1->oda_sayi"))) {echo "selected=\"selected\"";} ?>>15               Oda</OPTION></SELECT> </TD></TR>
        <TR>
          <TD colSpan=4>
            <HR color=#c1dad7 SIZE=1 width="100%" noShade>
          </TD></TR>
        <TR>
          ...
          <TD colSpan=2><SELECT style="WIDTH: 150px" class=input 
              name=salonoda>
            <OPTION selected value=0 <?php if (!(strcmp(0, "$veri1->salon_sayisi"))) {echo "selected=\"selected\"";} ?>>Bilgi Yok</OPTION>
          <OPTION 
              value=1 <?php if (!(strcmp(1, "$veri1->salon_sayisi"))) {echo "selected=\"selected\"";} ?>>1 Salon</OPTION><OPTION value=2 <?php if (!(strcmp(2, "$veri1->salon_sayisi"))) {echo "selected=\"selected\"";} ?>>2 Salon</OPTION><OPTION 
              value=3 <?php if (!(strcmp(3, "$veri1->salon_sayisi"))) {echo "selected=\"selected\"";} ?>>3 Salon</OPTION><OPTION value=4 <?php if (!(strcmp(4, "$veri1->salon_sayisi"))) {echo "selected=\"selected\"";} ?>>4 Salon</OPTION><OPTION 
              value=5 <?php if (!(strcmp(5, "$veri1->salon_sayisi"))) {echo "selected=\"selected\"";} ?>>5 Salon</OPTION></SELECT> </TD></TR>
        <TR>
          <TD colSpan=4>
            <HR color=#c1dad7 SIZE=1 width="100%" noShade>
          </TD></TR>
        <TR>
          ...
          <TD colSpan=2><SELECT style="WIDTH: 150px" class=input 
              name=yatakoda>
            <OPTION selected value=0 <?php if (!(strcmp(0, "$veri1->yatak_odasi_sayisi"))) {echo "selected=\"selected\"";} ?>>Bilgi Yok</OPTION>
            <OPTION 
              value=1 <?php if (!(strcmp(1, "$veri1->yatak_odasi_sayisi"))) {echo "selected=\"selected\"";} ?>>1 Yatak Odasý</OPTION>
            <OPTION value=2 <?php if (!(strcmp(2, "$veri1->yatak_odasi_sayisi"))) {echo "selected=\"selected\"";} ?>>2 Yatak               Odasý</OPTION>
          <OPTION value=3 <?php if (!(strcmp(3, "$veri1->yatak_odasi_sayisi"))) {echo "selected=\"selected\"";} ?>>3 Yatak Odasý</OPTION><OPTION 
              value=4 <?php if (!(strcmp(4, "$veri1->yatak_odasi_sayisi"))) {echo "selected=\"selected\"";} ?>>4 Yatak Odasý</OPTION><OPTION value=5 <?php if (!(strcmp(5, "$veri1->yatak_odasi_sayisi"))) {echo "selected=\"selected\"";} ?>>5 Yatak               Odasý</OPTION></SELECT> </TD></TR>
        <TR>
          <TD colSpan=4>
            <HR color=#c1dad7 SIZE=1 width="100%" noShade>
          </TD></TR>
        <TR>
          ...
          <TD colSpan=2><SELECT style="WIDTH: 150px" class=input name=banyo>
            <OPTION selected value=0 <?php if (!(strcmp(0, "$veri1->banyo_sayisi"))) {echo "selected=\"selected\"";} ?>>Bilgi Yok</OPTION>
            <OPTION value=1 <?php if (!(strcmp(1, "$veri1->banyo_sayisi"))) {echo "selected=\"selected\"";} ?>>1               Banyo</OPTION>
            <OPTION value=2 <?php if (!(strcmp(2, "$veri1->banyo_sayisi"))) {echo "selected=\"selected\"";} ?>>2 Banyo</OPTION>
            <OPTION value=3 <?php if (!(strcmp(3, "$veri1->banyo_sayisi"))) {echo "selected=\"selected\"";} ?>>3               Banyo</OPTION>
          <OPTION value=4 <?php if (!(strcmp(4, "$veri1->banyo_sayisi"))) {echo "selected=\"selected\"";} ?>>4 Banyo</OPTION><OPTION value=5 <?php if (!(strcmp(5, "$veri1->banyo_sayisi"))) {echo "selected=\"selected\"";} ?>>5               Banyo</OPTION></SELECT> </TD></TR>
        <TR>
          <TD colSpan=4>
            <HR color=#c1dad7 SIZE=1 width="100%" noShade>
          </TD></TR>
...
/* $data_yapi_tipi[$i] = '
<INPUT id=kd0 value='.$veri->id.'  type=radio  name=kd><LABEL for=kd0>'.$veri->adi.'</LABEL>'; */
if ($veri1->balkon==$veri->id) {  $secilimi= "checked=\"checked\"";}

$data_balkon[$i] = '<INPUT    '.$secilimi.'  id=balkon'.$veri->id.' value='.$veri->id.'  type=radio 
 name=balkon> <LABEL for=balkon0>'.$veri->adi.'</LABEL>';
...
/* $data_yapi_tipi[$i] = '
<INPUT id=kd0 value='.$veri->id.'  type=radio  name=kd><LABEL for=kd0>'.$veri->adi.'</LABEL>'; */
if ($veri1->bahce==$veri->id) {  $secilimi= "checked=\"checked\"";}

$data_bahce[$i] = '<INPUT    '.$secilimi.'  id=bahce'.$veri->id.' value='.$veri->id.'  type=radio 
 name=bahce> <LABEL for=bahce0>'.$veri->adi.'</LABEL>';

 
$i++;
$secilimi="";
	 } 
 echo resim_listele(4,2,2,$data_bahce); 
 ...
 ?></TD>
        ...
        <TR>
          ...
          <TD><table width="65%" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                  <td width="5%" nowrap="nowrap"><input  <?php if (!(strcmp("$veri1->ilan_suresi","14"))) {echo "checked=\"checked\"";} ?> id="sure2" value="14"  type="radio" name="sure" /></td>
                  <td width="13%" nowrap="nowrap"><label for="sure2">2 Hafta</label></td>
                  <td width="5%" nowrap="nowrap"><input  <?php if (!(strcmp("$veri1->ilan_suresi","30"))) {echo "checked=\"checked\"";} ?> id="sure2" value="30" type="radio" name="sure" /></td>
                  <td width="13%" nowrap="nowrap"><label for="sure2">1 Ay</label></td>
                  <td width="5%" nowrap="nowrap"><input  <?php if (!(strcmp("$veri1->ilan_suresi","60"))) {echo "checked=\"checked\"";} ?> id="sure2" value="60"  type="radio" name="sure" /></td>
                  <td width="13%" nowrap="nowrap"><label for="sure2">2 Ay</label></td>
                  <td width="5%" nowrap="nowrap"><input  <?php if (!(strcmp("$veri1->ilan_suresi","90"))) {echo "checked=\"checked\"";} ?> id="sure2" value="90"  type="radio" name="sure" /></td>
        ...
        <TR>
          ...
          <TD>&nbsp;</TD>
          <TD colSpan=2><label>
            <input type="text" class=input name="dosya_no" id="dosya_no" value="<?php echo $veri1->dosya_no; ?>" />
        ...
        <TR>
          <TD colSpan=4>
            <DIV align=center>
              ...
              <input value="&#304;lan&#305; Kaydet" type=submit name="gitti"  onclick=" return kontrol()" />
