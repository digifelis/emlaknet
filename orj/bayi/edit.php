...
if($veri1->ilan_grup == 1) { require_once("bayi/edit_form1.php");};
if($veri1->ilan_grup == 2) { require_once("bayi/edit_form2.php");};
if($veri1->ilan_grup == 3) { require_once("bayi/edit_form3.php");};
}
 ?>