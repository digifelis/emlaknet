...
<table border="0" cellspacing="3" cellpadding="3" width="100%" 
  ...
  <tbody>
    <tr>
      <td valign="top" width="16%" nowrap="nowrap"><?php 
 ...
 foreach( $veriler as $veri )
{
 ...
 ?></td>
      <td width="1%">&nbsp;</td>
      <td valign="top" width="23%" nowrap="nowrap"><?php 
 ...
 foreach( $veriler as $veri )
{
 ...
 ?></td>
      ...
      <td valign="top" width="22%" nowrap="nowrap"><?php 
 ...
 foreach( $veriler as $veri )
{
 ...
 ?></td>
      <td valign="top" width="1%" nowrap="nowrap">&nbsp;</td>
      <td valign="top" width="36%" nowrap="nowrap"><?php 
 ...
 foreach( $veriler as $veri )
{
 ...
 ?></td>
      <td valign="top" width="2%" nowrap="nowrap">&nbsp;</td>
      <td valign="top" width="36%" nowrap="nowrap"><?php 
