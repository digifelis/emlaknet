...

{
    ...
    */
...

    {
        ...
        $this->vt_name      = '';         // baðlanýlacak olan veritabaný adý

        $this->vt_user      = '';         // veritabaný için kullanýcý adý
    ...
    */
...

    {
        ...
        if( is_array($args[0]) ) {
            ...
            $this->vt_host = is_string($args[3]) ? $args[2] : 'localhost';
