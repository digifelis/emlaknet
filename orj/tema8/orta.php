...
<div class="sol_item">
    ...
    <div class="sol_item_orta">   
        ...
        <p style="margin-top:6px; float:left;"><a href="index.php?action=sifremi_unuttum">Þifremi unuttum</a></p>
...
<tr>
<th  colspan="3" align="left" valign="top"><center>

EmlaknetT&#252;rkiye olarak kurumsal &#220;yelerimize kendi web Sitelerini &#220;CRETS&#304;Z olu&#351;turma hizmetini en k&#305;sa zamanda ba&#351;latm&#305;&#351; bulunaca&#287;&#305;z. Ekledi&#287;iniz ilanlar EmlaknetT&#252;rkiye ve sizin sitenizde listelenecektir.
Bu Hizmetten faydalanmak i&#231;in sizin ad&#305;n&#305;za olu&#351;turulmu&#351; sayfan&#305;za domain adresinizi y&#246;nlendiriniz. E&#287;er Bu i&#351;lemi yapamayaca&#287;&#305;n&#305;z&#305; d&#252;&#351;&#252;n&#252;yorsan&#305;z y&#305;ll&#305;k 40 TL &#252;cret ile sizin ger&#231;ekle&#351;tirebiliriz.
Soru ve G&#246;r&#252;&#351;leriniz i&#231;in &#304;leti&#351;im b&#246;l&#252;m&#252;nden mesaj g&#246;nderebilirsiniz.
<br>
    <a href="http://bestas_emlak.emlaknetturkiye.com/index.php"> &#214;rnek site </a>
...
if($vt->alTek() != "")
{ 
$ilan_resim = '<img class="photo" name=""  src="thumb.php?p=resimler/'.$vt->alTek().'&w=100&h=75" alt="" width="120px" height="90px" border="0" />';
} else { 
...
<div class="ilanitem_baslik"><span property="gr:name">'.$ilan_tipi.'</span></div>
<div class="ilanitem_foto">
<a href="detail_'.$veri->id.'_'.$ilan_adres.'" title="'.$ilan_basligi.'"><span rel="foaf:depiction">'.$ilan_resim.'</span></a></div>
							<div class="ilanitem_detay">
								
								<p><b>Þehir :<span property="gr:description"> </b>'.$ilan_il.'</p>
								<p><b></b>'.$ilan_ilce.'</p>
</span>
								<p><b>Fiyat : </b><span property="gr:price">'.ondalik($veri->fiyat)."&nbsp;".$birim.'</span>
<span property="gr:hasCurrency" content="TUR" ></span>
</p>
								
								<p align="right">
<span property="foaf:page"> <a href="detail_'.$veri->id.'_'.$ilan_adres.'" style="color:#333; text-decoration:underline;" title="'.$ilan_basligi.'">Detaylý Ýncele</a></span>
								</p>
							</div>
						</div>'; 
