                          ...
                          <TR>
                            <TD colSpan=4><!-- order start -->
                              ...
                              width="100%" align=right>
                                ...
                                <TD noWrap>&nbsp;<A 
                                href="?action=ilan&subaction=ilan_listeg&amp;showstatus=2&amp;sortorder=desc&id=<?php echo $_GET["id"]; ?>">Kay&#305;tl&#305; 
                                ( Aktif )</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="../tema/img/flag_orange.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=ilan&subaction=ilan_listeg&amp;showstatus=0&amp;sortorder=desc&id=<?php echo $_GET["id"]; ?>">Kontrol 
                                A&#351;amas&#305;nda</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="../tema/img/flag_red.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=ilan&subaction=ilan_listeg&amp;showstatus=1&amp;sortorder=desc&id=<?php echo $_GET["id"]; ?>">Blokeli</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="../tema/img/flag_white.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=ilan&subaction=ilan_listeg&amp;showstatus=3&amp;sortorder=desc&id=<?php echo $_GET["id"]; ?>">S&uuml;resi 
                                Dolmu&#351;</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="../tema/img/award_star_bronze_1.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=ilan&subaction=ilan_listeg&amp;showstatus=4&amp;sortorder=desc&id=<?php echo $_GET["id"]; ?>">Vitrin 
                                &#304;lanlar</A></TD>
                                <TD height=16 width=16><IMG border=0 alt="" 
                                src="../tema/img/flag_blue.gif" 
                                width=16 height=16></TD>
                                <TD noWrap>&nbsp;<A 
                                href="?action=ilan&subaction=ilan_listeg&amp;sortorder=desc&id=<?php echo $_GET["id"]; ?>">T&uuml;m 
...
if(temizle($_GET["showstatus"]) != "") { $kriter .='and onay in ("'.temizle($_GET["showstatus"]).'") '; };

 $vt->sql('select id,uye_id , tarih,ilan_tipi_id,ilan_grup,il,ilce,koy,fiyat,birim,ilan_suresi,bas_tarihi,hit,onay from ilan_ticari where id > 0   '.$kriter.'  order by id '.temizle($_GET["sortorder"]).'  ')->sor(); 
...
$vt->sql('select id,uye_id , tarih,ilan_tipi_id,ilan_grup,il,ilce,koy,fiyat,birim,ilan_suresi,bas_tarihi,hit,onay , bloke_sebebi from ilan_ticari where id > 0    '.$kriter.'  order by id '.temizle($_GET["sortorder"]).' '. $limit .' ')->sor();
					  $veriler = $vt->alHepsi();
					if( $vt->numRows()==0) {
...
echo ' <IMG border=0 src="../thumb.php?p=resimler/'.$foto_adi.'&w=100&h=75" >'; 	
 ...
 ?>    
                             ...
                             <!--   <form id="<?php echo $veri->id;  ?>" name="form" method="POST" action="javascript:void(0);">
                                <input name="ilan_id" type="hidden" value="<?php echo $veri->id;  ?>" id="ilan_id" /> -->
                                  <table width="200">
                                    <tr>
                                      <td nowrap="nowrap">
  
                                      <label>
                                        <input <?php if (!(strcmp("$veri->onay","2"))) {echo "checked=\"checked\"";} ?> type="radio" name="RadioGroup1" value="2" id="RadioGroup1" />
                                        Aktif</label>
                                        
                                        
                                        
                                        </td>
                                      <td nowrap="nowrap"><input <?php if (!(strcmp("$veri->onay","1"))) {echo "checked=\"checked\"";} ?> type="radio" name="RadioGroup1" value="1" id="RadioGroup1" />
Blokeli</td>
                                      </tr>
                                    <tr>
                                      ...
                                      <td nowrap="nowrap"><input <?php if (!(strcmp("$veri->onay","3"))) {echo "checked=\"checked\"";} ?> type="radio" name="RadioGroup1" value="3" id="RadioGroup1" />
S&uuml;resi dolmuþ</td>
                                      </tr>
                                    <tr>
                                      <td nowrap="nowrap"><input <?php if (!(strcmp("$veri->onay","4"))) {echo "checked=\"checked\"";} ?> type="radio" name="RadioGroup1" value="4" id="RadioGroup1" />
Vitrin</td>
                                      <td nowrap="nowrap"><label>

<textarea rows="4" cols="15" name="bloke" id="bloke">
<?php 
$Degisken=iconv("UTF-8", "ISO-8859-9",$veri->bloke_sebebi );
                  echo $Degisken;

?></textarea>

                                        <input type="submit" name="button<?php echo $veri->id;  ?>" id="button<?php echo $veri->id;  ?>"  value="Deðiþikliði Kaydet" />
                                      </label></td>
                                      </tr>
                                    </table>
                                </form>
...
echo $vt->alTek(); 
 ?>
                                ...
                                href="?action=ilan&subaction=eleman_ekle&amp;id=<?php echo $veri->id; ?>">Satis 
                                ...
                                width=16 height=16></TD>
                                <TD><A 
                                href="?action=ilan&subaction=edit&amp;s=<?php echo $veri->ilan_grup; ?>&amp;oid=<?php echo $veri->id; ?>">Ilan 
                                ...
                                width=16 height=16></TD>
                                <TD noWrap><A 
                                href="?action=ilan&subaction=pictures&amp;id=<?php echo $veri->id; ?>">Fotograf 
                                Islemi</A></TD></TR>
                                <TR>
                                <TD><IMG border=0 alt="" 
                                ...
                                href="?action=ilan&subaction=ilan_sil&amp;id=<?php echo $veri->id; ?>">Ilan 
                                Silme 
 ...
 <?php       } ?>                    
                          ...
                          <TR>
                            <TD colSpan=4>
                              <HR color=#c0c0c0 SIZE=1 width="100%" noShade>
                       <?php 
  echo "<center><h4>".sayfala(temizle($_GET["sayfa"]),$toplam_kayit,$sayfadaki_kayit_sayisi,'action=ilan&subaction=ilan_listeg&showstatus='.temizle($_GET["showstatus"]).'&sortorder=desc')."</h4></center>";
