...
$secilimi="";
 ...
 echo resim_listele(4,2,2,$data_yapi_durum); 
 ...
 ?></TD></TR>
        ...
        <TR>
          ...
          <TD colSpan=2><INPUT 
            ...
            onkeypress="return numbersonly(this, event)" value="<?php echo $veri1->fiyat; ?>" size=10 maxLength=10> m&sup2;</TD></TR>
        <TR>
          <TD colSpan=4>
            <HR color=#c1dad7 SIZE=1 width="100%" noShade>
          </TD></TR>
...
$secilimi="";
 ...
 echo resim_listele(4,2,2,$data_balkon); 
...
$secilimi="";
 ...
 ?>&nbsp;</TD></TR>
        ...
        <TR>
          ...
          <TD>&nbsp;:&nbsp;</TD>
          <TD><INPUT 
          name=adres class=input style="WIDTH: 100%" value="<?php echo $veri1->adres; ?>" maxLength=100></TD>
          <TD><A 
            href="?action=ilanver" 
        ...
        <TR>
          ...
          <TD><INPUT name=postakodu class=input onKeyPress="return numbersonly(this, event)" value="<?php echo $veri1->posta_kodu; ?>" size=6 
            maxLength=5>&nbsp;&nbsp;&nbsp;&nbsp; 
          <STRONG>Ýl/Ýl&ccedil;e/Semt</STRONG> &nbsp;&nbsp;<INPUT name=yer class=input value="<?php echo $veri1->il_ilce; ?>" size=30 
            maxLength=100></TD>
          <TD><A 
            href="?action=ilanver" 
        ...
        <TR>
          ...
          <TD><FONT color=#ff0000><STRONG>A&ccedil;ýklama Alanýndaki Yazýlarýn 
            ...
            color=#ff0000><STRONG>Bu Alanda A&ccedil;ýklama Dýþýnda Yazýlmasý Yasak 
            Olan Bilgiler: <BR>Telefon Numarasý, Web Adresi, E-Mail Adresi, 
            Fiyat Bilgisi ...v.s.</STRONG></FONT> </TD>
          <TD><A 
            href="?action=ilanver" 
          ...
          <TD><table width="65%" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                  ...
                  <td width="5%" nowrap="nowrap"><input  <?php if (!(strcmp("$veri1->ilan_suresi","180"))) {echo "checked=\"checked\"";} ?> id="sure5" value="180" type="radio" name="sure" /></td>
                  <td width="10%" nowrap="nowrap"><label for="sure5">6 Ay&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
                  <td width="6%" nowrap="nowrap"><input  <?php if (!(strcmp("$veri1->ilan_suresi","365"))) {echo "checked=\"checked\"";} ?> id="sure6" value="365" type="radio" name="sure" /></td>
                  <td width="8%" nowrap="nowrap"><label for="sure6">1 Y&#305;l</label></td>
                </tr>
            </tbody>
            </table></TD>
          <TD><A 
        ...
        <TR>
          <TD noWrap>
            <DIV align=right><STRONG>Kira/Satýþ Tarihi</STRONG></DIV></TD>
          <TD>&nbsp;:&nbsp;</TD>
          <TD><INPUT name=kirasatis class=input value="<?php echo $veri1->satis_tarihi; ?>" size=30 maxLength=30></TD>
          <TD><A 
            href="?action=ilanver" 
        ...
        <TR>
          <TD></TD>
          <TD></TD>
          <TD colSpan=2><FONT color=#ff0000 size=4><STRONG>Ýlan Kurallarýna 
