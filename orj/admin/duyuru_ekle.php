...
$vt->sql("insert into duyuru (baslik,icerik,tarih,gorunme)  values ('".temizle($_POST["baslik"])."' , '".temizle($_POST["haber"])."' , '".$son_zaman."' , '".temizle($_POST["gorunme"])."') ")->sor();
 if($vt->affRows() > 0)
 { echo "<center>DUYURU BAÞARILI BÝR ÞEKÝLDE EKLENDÝ.</center>"; } else {echo "<center> DUYURU EKLEMEDE HATA OLUÞTU LÜTFEN TEKRAR DENEYÝNÝZ!!!! </center> "; }
...
<table width="100%" border="0">
  <tr>
    <th width="18%" align="right" valign="top" scope="row">Duyuru Baþlýðý :</th>
    <td width="82%"><label>
  ...
  <tr>
    <th align="right" valign="top" scope="row">Duyuru i&ccedil;eriði :</th>
    <td>
