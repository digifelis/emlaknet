...
<TABLE border=0 cellSpacing=0 cellPadding=0 style="width:98%" 
      ...
      <div class="baslik_sag stil10"><br />
        <span class="stil55">V&#304;TR&#304;N &#304;LANLARI</span></div>
      </div>      </TD>
                </TR>
              <TR>
...
<!--vitrin ilanlar bitimi -->
  ...
  <tr>
    <td colspan="4" align="left"><div class="baslik">
      <div class="baslik_sol"></div>
      <div class="baslik_sag"><br />
        <span class="stil55">EMLAK&Ccedil;ILAR</span></div>
    </div></td>
  </tr>
  <tr>
    <td>
	<?php
	$vt->sql("SELECT uyeler.temiz_ad , uyeler.sirket , sehir.sehiradiUpper , count(ilan_ticari.id) as sayi  FROM  uyeler , sehir , ilan_ticari WHERE uyeler.il =  sehir.plaka and uyeler.uye_tipi='1' group by uyeler.id ORDER BY uyeler.id asc LIMIT 0,7  ")->sor();
	$veriler = $vt->alHepsi();
	foreach($veriler as $veri) {
    ...
    <td>
	<?php 
	$vt->sql("SELECT uyeler.temiz_ad , uyeler.sirket , sehir.sehiradiUpper , count(ilan_ticari.id) as sayi  FROM  uyeler , sehir , ilan_ticari WHERE uyeler.il =  sehir.plaka and uyeler.uye_tipi='1'  group by uyeler.id ORDER BY uyeler.id asc LIMIT 7,7  ")->sor();
	$veriler = $vt->alHepsi();
	foreach($veriler as $veri) {
		echo '<li><a  href="http://'.$veri->temiz_ad.'.'.$site.'" target="_blank">'.$veri->sirket.'</a>&nbsp;'.$veri->sehiradiUpper.'</li>';
	}
    ...
    <td>
	<?php 
	$vt->sql("SELECT uyeler.temiz_ad , uyeler.sirket , sehir.sehiradiUpper , count(ilan_ticari.id) as sayi  FROM  uyeler , sehir , ilan_ticari WHERE uyeler.il =  sehir.plaka and uyeler.uye_tipi='1'  group by uyeler.id ORDER BY uyeler.id asc LIMIT 14,7  ")->sor();
	$veriler = $vt->alHepsi();
	foreach($veriler as $veri) {
		echo '<li><a  href="http://'.$veri->temiz_ad.'.'.$site.'" target="_blank">'.$veri->sirket.'</a>&nbsp;'.$veri->sehiradiUpper.'</li>';
	}
    ...
    <td>
	<?php 
	$vt->sql("SELECT uyeler.temiz_ad , uyeler.sirket , sehir.sehiradiUpper , count(ilan_ticari.id) as sayi  FROM  uyeler , sehir , ilan_ticari WHERE uyeler.il =  sehir.plaka and uyeler.uye_tipi='1'  group by uyeler.id ORDER BY uyeler.id asc LIMIT 21,7   ")->sor();
	$veriler = $vt->alHepsi();
	foreach($veriler as $veri) {
		echo '<li><a  href="http://'.$veri->temiz_ad.'.'.$site.'" target="_blank">'.$veri->sirket.'</a>&nbsp;'.$veri->sehiradiUpper.'</li>';
	}
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr>
       <td colspan="3" align="left"><div class="baslik">
         <div class="baslik_sol"></div>
         <div class="baslik_sag"><br />
           <span class="stil55">M&Uuml;TEAHH&#304;T F&#304;RMALAR</span></div>
       </div></td>
     </tr>
     <tr>
       <td><?php
       ...
       <tr>
         <td colspan="5" align="left" valign="top"><div class="baslik">
           ...
           <div class="baslik_sag">
             <div align="left" class="stil55"><br />
               YEN&#304; &#304;LANLAR</div>
           </div>
         </div></td>
       </tr>
...
$vt->sql("select * from ilan_ticari where onay !='1' and onay !='3' order by id DESC limit 10,1 ")->sor();
/// $vt->sql("SELECT * FROM ilan_ticari where onay !='1' and onay !='3' ORDER BY id DESC LIMIT 5,1")->sor();
$veriler = $vt->alHepsi();
foreach($veriler as $veri) { 
...
$vt->sql("select * from ilan_ticari where onay !='1' and onay !='3' order by id DESC limit 11,1 ")->sor();
///$vt->sql("SELECT * FROM ilan_ticari where onay !='1' and onay !='3' ORDER BY id DESC LIMIT 6,1")->sor();
$veriler = $vt->alHepsi();
foreach($veriler as $veri) { 
...
$vt->sql("select * from ilan_ticari where onay !='1' and onay !='3' order by id DESC limit 12,1 ")->sor();
...
$vt->sql("select * from ilan_ticari where onay !='1' and onay !='3' order by id DESC limit 13,1 ")->sor();
...
$vt->sql("select * from ilan_ticari where onay !='1' and onay !='3' order by id DESC limit 14,1 ")->sor();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="5" align="left">
      ...
      <div class="baslik_sol"></div>
      <div class="baslik_sag"><br />
        <span class="stil55">&#304;LAN KATEGOR&#304;LER&#304;</span></div>
      </div>      </td>
    </tr>
    <tr>
