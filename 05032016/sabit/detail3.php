...
<?php 
	...
	$vt->sql('select * from reklam where yer=11 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor();
...
<img src="resimler/'.$veri->foto.'" width="100" />
  ';
   ...
   &Uuml;yenin di&#287;er ilanlar&#305; i&ccedil;in t&#305;klay&#305;n&#305;z
    </a>        
     </b></font></TD>
        </TR>
        </TBODY>
