...
<table width="100%" border="0">
  <tr>
    <th colspan="2" bgcolor="#D5D5D5">AYRINTILI KONUT  &#304;LAN ARAMA</th>
  </tr>
  <tr>
    <td width="23%"><br />
      <FONT color=#006600 
 ...
 ?>
  ...
  ?>
    ...
    <td nowrap="nowrap"><FONT color=#006600 
                        size=2><STRONG>Oda Say&#305;s&#305;</STRONG></FONT><br />
      <SELECT style="WIDTH: 130px" class=input 
                        name=oda_alt id="oda_alt"> <OPTION selected value=0>farketmez 
                          ------</OPTION> <OPTION value=1>1 Oda</OPTION> <OPTION 
                          value=2>2 Oda</OPTION> <OPTION value=3>3 Oda</OPTION> 
                          <OPTION value=4>4 Oda</OPTION> <OPTION value=5>5 
                          Oda</OPTION> <OPTION value=6>6 Oda</OPTION> <OPTION 
                          value=7>7 Oda</OPTION> <OPTION value=8>8 Oda</OPTION> 
                          <OPTION value=9>9 Oda</OPTION> <OPTION value=10>10 
                          Oda</OPTION> <OPTION value=11>11 Oda</OPTION> <OPTION 
                          value=12>12 Oda</OPTION> <OPTION value=13>13 
                          Oda</OPTION> <OPTION value=14>14 Oda</OPTION> <OPTION 
                          value=15>15 Oda</OPTION> <OPTION value=16>16 
                          Oda</OPTION> <OPTION value=17>17 Oda</OPTION> <OPTION 
                          value=18>18 Oda</OPTION> <OPTION value=19>19 
                          Oda</OPTION> <OPTION value=20>20 Oda</OPTION> <OPTION 
                          value=21>21 Oda</OPTION> <OPTION value=22>22 
                          Oda</OPTION> <OPTION value=23>23 Oda</OPTION> <OPTION 
                          value=24>24 Oda</OPTION> <OPTION value=25>25 
                          Oda</OPTION> <OPTION value=26>26 Oda</OPTION> <OPTION 
                          value=27>27 Oda</OPTION> <OPTION value=28>28 
                          Oda</OPTION> <OPTION value=29>29 Oda</OPTION> <OPTION 
                          value=30>30 Oda</OPTION></SELECT>
      &nbsp;ile&nbsp;&nbsp;
      <SELECT style="WIDTH: 130px" class=input 
                        name=oda_ust id="oda_ust"> <OPTION selected value=0>farketmez 
                          ------</OPTION> <OPTION value=1>1 Oda</OPTION> <OPTION 
                          value=2>2 Oda</OPTION> <OPTION value=3>3 Oda</OPTION> 
                          <OPTION value=4>4 Oda</OPTION> <OPTION value=5>5 
                          Oda</OPTION> <OPTION value=6>6 Oda</OPTION> <OPTION 
  ...
  <option value="">Il&ccedil;e se&ccedil;iniz</option>
    ...
    <td nowrap="nowrap"><FONT color=#006600 
                        size=2><STRONG>Balkon</STRONG></FONT>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <FONT color=#006600 
                        size=2><STRONG>Bah&ccedil;e</STRONG></FONT><br />
      <SELECT 
                        style="WIDTH: 130px" class=input name=balkon> 
                        
                 <?php  $vt->sql('select * from bahce ')->sor();
$veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{ echo ' <option value="'.$veri->id.'">'.$veri->adi.'</option>'; }     
                      ?>  
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<SELECT 
                        style="WIDTH: 130px" class=input name=bahce> 
                         <?php  $vt->sql('select * from balkon ')->sor();
$veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{ echo ' <option value="'.$veri->id.'">'.$veri->adi.'</option>'; }     
                      ?> 
...
$i++;
 ...
 ?>                         
  ...
  <tr>
    ...
    <td nowrap="nowrap">
   <FONT color=#006600 
                        size=2><STRONG>&#304;ç donanim</STRONG></FONT><br />
...
name=a1 type=checkbox  id=a1 value='.$veri->id.'  />  <LABEL for=d41>'.$veri->adi.'</LABEL>';
 ...
 ?>
  ...
  <tr>
    ...
    <td nowrap="nowrap"><FONT color=#006600 
                        size=2><STRONG>D&#305;s Donanim</STRONG></FONT> <br />
