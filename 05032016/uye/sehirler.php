            ...
            bgColor=#f7f7f7 align=center>
              ...
              <TR>
                ...
                style="BORDER-BOTTOM: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; BORDER-TOP: #cccccc 1px solid; BORDER-RIGHT: #cccccc 1px solid">
                  <DIV align=center><STRONG><FONT size=4>L&uuml;tfen &#351;ehir se&ccedil;iniz
                  </FONT></STRONG></DIV>
                  ...
                  align=center>
                    ...
                    <TR>
					  ...
					  $vt->sql('select * from sehir  order by sehiradiUpper ASC limit 0,22   ')->sor();
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
	echo ' 
	<A class=f2  href="start.php?action=ilce&amp;b='.$veri->sehirID.'&amp;a='.temizle($_GET["a"]).'&amp;s='.temizle($_GET["s"]).'">'.$veri->sehiradiUpper.'</A><BR>
	';
}
 ?></TD>
                      <TD width="25%" valign="top">
                                                    ...
                                                    <?php 
					  $vt->sql('select * from sehir  order by sehiradiUpper  ASC limit 22,22 ')->sor();
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
	echo ' 
 ...
 ?>
                      ...
                      <TD vAlign=top width="32%" noWrap>
                                                                      <?php 
					  $vt->sql('select * from sehir  order by sehiradiUpper  ASC limit 44,22  ')->sor();
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
	echo ' 
 ...
 ?></TD>
                      <TD vAlign=top width="21%" noWrap>
                                                                       <?php 
					  $vt->sql('select * from sehir  order by sehiradiUpper  ASC limit 66,22   ')->sor();
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
	echo ' 
