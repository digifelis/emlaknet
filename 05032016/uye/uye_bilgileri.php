...
$vt->sql('update `uyeler` set  sifre="'.$_POST['pass1'].'"  , isim_soyad = "'.temizle($_POST['name']).'"  , adres = "'.temizle($_POST['adresse']).'" , posta_kodu="'.temizle($_POST["plz"]).'",ilce="'.temizle($_POST["ort"]).'",il="'.temizle($_POST["region_bundesland"]).'",email="'.temizle($_POST["email"]).'",tel1="'.temizle($_POST["telefon"]).'",ceptel="'.temizle($_POST["handy"]).'" ,kod1="'.temizle($_POST["telefon_areacode"]).'",kod3="'.temizle($_POST["handy_areacode"]).'"    where id= "'.$_SESSION['id'].'"');
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          width=129>
            ...
            height=1><BR><STRONG><FONT color=#ffffff>Yleti?im 
         ...
         ?> 
                    ...
                    <TR>
                      <TD colSpan=2>
                        ...
                        <BR>Doldurulmasy gereken alanlaryn tamamy zorunlu 
                        alanlardyr.</DIV></TD></TR></TBODY></TABLE></FORM></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
<?php
}
?>