<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          background=tema/img/fahne1.gif 
            ...
            height=1><BR><STRONG><FONT color=#ffffff>Ýlan Silme</FONT></STRONG></DIV></TD>
            ...
            bgColor=#f7f7f7 align=center>
              ...
              <TR>
                ...
                style="BORDER-BOTTOM: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; BORDER-TOP: #cccccc 1px solid; BORDER-RIGHT: #cccccc 1px solid"><FONT 
                  ...
                  <?php 
		$vt->sql("delete from ilan_ticari where id = '".temizle($_GET["id"])."' and uye_id = '".$_SESSION["id"]."'")->sor();		  
...
$vt->sql("delete from ilan_foto where ilan_id = '".temizle($_GET["id"])."' ")->sor();
}
 
 } else { echo "<h3>Ilan Kaydinda Hata Olustu . Hata Kodu S1100.<br>Hata devam ederse Lütfen Site Yöneticisine Bildiriniz.</h3>"; }
				  ?>
