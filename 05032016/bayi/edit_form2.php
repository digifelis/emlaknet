...
$vt->sql("update ilan_ticari set  `fiyat` = '".temizle($_POST["fiyat"])."', `birim` = '".temizle($_POST["fiyat_art"])."',`kullanim_durumu` = '".temizle($_POST["kullandurum"])."', kullanim_amaci = '".temizle($_POST["kullanimamaci"])."',toplam_metrekare = '".temizle($_POST["metrekare"])."',kullanilabilir_metrekare = '".temizle($_POST["metrekare2"])."',`yapi_tipi` = '".temizle($_POST["yapitipi"])."',`yapi_durum` = '".temizle($_POST["yapidurum"])."',`bulundugu_kat` = '".temizle($_POST["kat"])."', `bina_kat_sayisi` = '".temizle($_POST["kat2"])."', `yapim_yili` = '".temizle($_POST["yil"])."',`isinma_tipi` = '".temizle($_POST["isitma"])."',`yakit_tipi` = '".temizle($_POST["yakittipi"])."',`adres` = '".temizle($_POST["adres"])."', `posta_kodu` = '".temizle($_POST["postakodu"])."', `il_ilce` = '".temizle($_POST["yer"])."', `aciklama` = '".temizle($_POST["aciklama"])."', `ilan_suresi` = '".temizle($_POST["sure"])."', `satis_tarihi` = '".temizle($_POST["kirasatis"])."' , kredi='".temizle($_POST["kredi"])."' , dosya_no='".temizle($_POST["dosya_no"])."' ,gx='".temizle($_POST["x"])."', gy='".temizle($_POST["y"])."' ,onay='2' where id= '".temizle($_GET["oid"])."' ");
