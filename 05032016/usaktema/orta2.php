...
<?php 
	$vt->sql('select * from reklam where yer=17 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
...
?>
<?php 
	$vt->sql('select * from reklam where yer=18 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
	//$vt->sql('select * from reklam where yer=1 order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod."<br>";
...
?>
<?php 
	$vt->sql('select * from reklam where yer=19 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
	//$vt->sql('select * from reklam where yer=1 order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod."<br>";
...
?>
<?php 
	$vt->sql('select * from reklam where yer=20 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
	//$vt->sql('select * from reklam where yer=1 order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod."<br>";
...
<table width="95%" border="0">
  <tr>
    <td><?php $vt->sql('select * from reklam where yer=4 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod;
}
?></td>
    <td><?php $vt->sql('select * from reklam where yer=5 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod;
}
?></td>
    <td><?php $vt->sql('select * from reklam where yer=6 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod;
}
?></td>
    <td><?php $vt->sql('select * from reklam where yer=7 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod;
}
  ...
  <tr align="center" valign="middle">
    <td valign="top">
      ...
      src="tema1/img/line_green_173px.gif"> 
		...
		$vt->sql("select count(id)  from ilan_ticari where ilan_tipi_id between '1' and '9' and ilan_grup='1' and  onay != '1' and onay !='3' ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?>  
            <LI><IMG src="tema1/img/arrow_green.gif"  height="5" width="4"> <A 
		...
		$vt->sql("select count(id)  from ilan_ticari where ilan_tipi_id between '10' and '19' and ilan_grup='1' and  onay != '1' and onay !='3' ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?>  
              <LI><IMG src="tema1/img/arrow_green.gif"  height="5" width="4"> <A 
		...
		$vt->sql("select count(id)  from ilan_ticari where ilan_grup='1' and  onay != '1' and onay !='3'  ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?>         
    ...
    <td valign="top">
      ...
      src="tema1/img/line_blue_173px.gif"> 
        ...
        href="index.php?action=arama&amp;tip=1&amp;grup=2&amp;liste=1">Sat&#305;l&#305;k</A> 
         <?php 
		$vt->sql("select count(id)  from ilan_ticari where ilan_tipi_id between '34' and '56' and ilan_grup='2' and  onay != '1' and onay !='3' ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?>  
            <LI><IMG src="tema1/img/arrow_blue.gif"  height="5" width="4"> <A 
        href="index.php?action=arama&amp;tip=0&amp;grup=2&amp;liste=1">Kiral&#305;k</A> 
         <?php 
		$vt->sql("select count(id)  from ilan_ticari where ilan_tipi_id between '57' and '79' and ilan_grup='2' and  onay != '1' and onay !='3'  ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?>  
              <LI><IMG src="tema1/img/arrow_blue.gif"  height="5" width="4"> <A 
        href="index.php?action=arama&amp;grup=2&amp;liste=1">T&uuml;m Ticari</A> 
         <?php 
		$vt->sql("select count(id)  from ilan_ticari where ilan_grup='2' and  onay != '1' and onay !='3'  ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?> 
               </UL><IMG class="marTop10px marBottom10px" 
    ...
    <td valign="top">
      ...
      src="tema1/img/line_yellow_173px.gif"> 
        ...
        href="index.php?action=arama&amp;tip=1&amp;grup=3&amp;liste=1">Sat&#305;l&#305;k</A>
         <?php 
		$vt->sql("select count(id)  from ilan_ticari where ilan_tipi_id between '20' and '27' and ilan_grup='3'  and  onay != '1' and onay !='3'  ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?>  
            <LI><IMG src="tema1/img/arrow_yellow.gif"  height="5" width="4"> <A 
        ...
        href="index.php?action=arama&amp;tip=0&amp;grup=3&amp;liste=1">Kiral&#305;k</A> 
         <?php 
		$vt->sql("select count(id)  from ilan_ticari where ilan_tipi_id between '28' and '33' and ilan_grup='3' and  onay != '1' and onay !='3'   ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?>  
              <LI><IMG src="tema1/img/arrow_yellow.gif"  height="5" width="4"> <A 
        href="index.php?action=arama&amp;grup=3&amp;liste=1">T&uuml;m Arsalar</A> 
         <?php 
		$vt->sql("select count(id)  from ilan_ticari where ilan_grup='3'  and  onay != '1' and onay !='3'   ")->sor(10);
      echo '&nbsp;('.$vt->alTek().')';   
      ?>    
             </UL><IMG class="marTop10px marBottom10px" 
        ...
        <span class="stil11">V&#304;TR&#304;N &#304;LANLAR</span></div>
              ...
              <TR>
                <TD vAlign=top>
                  ...
                  <?php 
  		$vt->sql("select id from ilan_ticari where onay='4' ")->sor(10);
				$veriler = $vt->alHepsi();
...
$vt->sql("select * from ilan_ticari where onay='4' and id='".$rastgele_id."' ")->sor(10);

///$vt->sql("SELECT * FROM ilan_ticari where onay='4' ORDER BY RAND() LIMIT 1,1")->sor(10);
$veriler = $vt->alHepsi();
foreach($veriler as $veri) { 
$uye_no = $veri->uye_id;
 $vt->sql('select adi from ilan_tipi where id="'.$veri->ilan_tipi_id.'"   ')->sor(10);
$ilan_tipi = $vt->alTek(); 

$vt->sql('select sehiradiUpper from sehir where sehirID="'.$veri->il.'"   ')->sor(10);
$ilan_il = $vt->alTek(); 

$vt->sql('select ilceAdi from ilce where ilceID="'.$veri->ilce.'" and sehirID="'.$veri->il.'"   ')->sor(10);
$ilan_ilce = $vt->alTek();

$vt->sql('select mahalleAdi from mahalle where mahalleID="'.$veri->koy.'" and ilceID="'.$veri->ilce.'" and sehirID="'.$veri->il.'"    ')->sor(10);
$ilan_koy = $vt->alTek();
...
$vt->sql('select uye_tipi from uyeler where id= "'.$uye_no.'" ')->sor(10); 
$uye_tipi = $vt->alTek();

$vt->sql('select foto_adi from ilan_foto where ilan_id="'.$veri->id.'" limit 0,1   ')->sor(10); $foto_adi = $vt->alTek();

if($foto_adi == "") {

if($uye_tipi == 1 or $uye_tipi == 3 ) {
$vt->sql("select firma_logo from logolar where user_id = '".$uye_no."'")->sor(10); 
if($vt->alTek() != "")
...
<script type="text/javascript" language="javascript">(function() {var rheight=250;var rwidth=300;var rpid=43424;var rpu=1;var rchnc=Math.random()%4325652;var ddomn=window.location.host;var tur = "reklamsoftreklam";var domaini = "http:/"+"/www.reklamsoft.com"+"/";var srcc="src="+domaini+tur+"-"+rchnc+"-"+rpid+"-"+rpu+"-"+ddomn+".aspx";var rmrbrdr="frameborder=0";var scrlng="scrolling='no'";document.write("<ifr"+"ame "+rmrbrdr+" width='"+rwidth+"' "+scrlng+" "+srcc+" height='"+rheight+"'></ifr"+"ame>");})();</script>

<?php $vt->sql('select * from reklam where yer=8 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod;
}
?></td>
    <td><?php $vt->sql('select * from reklam where yer=9 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod;
}
?></td>
    <td><?php $vt->sql('select * from reklam where yer=10 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod;
}
?></td>
    <td><?php $vt->sql('select * from reklam where yer=11 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod;
}
...
$vt->sql("select * from ilan_ticari where onay !='1' and onay !='3' order by id DESC limit ".$ii.",1 ")->sor(10);	

//$vt->sql("SELECT * FROM ilan_ticari where onay !='1' and onay !='3' ORDER BY id DESC LIMIT 0,1")->sor(10);
$veriler = $vt->alHepsi();
foreach($veriler as $veri) { 
$uye_no = $veri->uye_id;
 $vt->sql('select adi from ilan_tipi where id="'.$veri->ilan_tipi_id.'"   ')->sor(10);
...
'.$ilan_basligi.'</a><br /> '.ondalik($veri->fiyat)."&nbsp;".$birim.'<br /> </div></td>
	...
	<?php $vt->sql('select * from reklam where yer=12 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod."<br>";
}
?>	  
<?php $vt->sql('select * from reklam where yer=13 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod."<br>";
}
...
<?php 
	$vt->sql('select * from reklam where yer=14 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
	//$vt->sql('select * from reklam where yer=1 order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod."<br>";
...
?>
<?php 
	$vt->sql('select * from reklam where yer=15 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
	//$vt->sql('select * from reklam where yer=1 order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod."<br>";
...
?>
<?php 
	$vt->sql('select * from reklam where yer=16 and aktif="evet" and  bas_tarih<="'.$tarih .'"  and bit_tarih >= "'.$tarih .'" order by id desc')->sor(10);
	//$vt->sql('select * from reklam where yer=1 order by id desc')->sor(10);
$reklamlar = $vt->alHepsi();
foreach($reklamlar as $reklam){
echo $reklam->kod."<br>";
...
<li><A class=f2  href="index.php?action=arama&amp;tur='.$veri->id.'&amp;liste=1">'.$veri->adi.'</A>&nbsp;('.$veri->sayi.')</li>
 ...
 ?>            </td>
    <td align="left" valign="top" nowrap="nowrap">
     ...
     <?php 
 $vt->sql('select ilan_tipi.adi , ilan_tipi.id , (select count(ilan_ticari.id) from ilan_ticari where ilan_ticari.ilan_grup =1 and ilan_ticari.onay != 1 and ilan_ticari.onay != 3 and ilan_ticari.ilan_tipi_id=ilan_tipi.id) as sayi  from ilan_tipi , ilan_ticari where ilan_tipi.tip=1 and ilan_tipi.grup_id=1  group by ilan_tipi.adi limit 5,5  ')->sor(10);
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
echo ' 
...
<li><A class=f2  href="index.php?action=arama&amp;tur='.$veri->id.'&amp;liste=1">'.$veri->adi.'</A>&nbsp;('.$veri->sayi.')</li>
 ...
 ?>    </td>
    <td align="left" valign="top" nowrap="nowrap">
     ...
     <?php 
 $vt->sql('select ilan_tipi.adi , ilan_tipi.id , (select count(ilan_ticari.id) from ilan_ticari where ilan_ticari.ilan_grup =2 and ilan_ticari.onay != 1 and ilan_ticari.onay != 3 and ilan_ticari.ilan_tipi_id=ilan_tipi.id) as sayi  from ilan_tipi , ilan_ticari where ilan_tipi.tip=1 and ilan_tipi.grup_id=2  group by ilan_tipi.adi limit 10,10  ')->sor(10);
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
echo ' 
<li><A class=f2  href="index.php?action=arama&amp;tur='.$veri->id.'&amp;liste=1">'.$veri->adi.'</A>&nbsp;('.$veri->sayi.')</li>
 ...
 ?>    </td>
    <td align="left" valign="top" nowrap="nowrap">
     <?php 
 $vt->sql('select ilan_tipi.adi , ilan_tipi.id , (select count(ilan_ticari.id) from ilan_ticari where ilan_ticari.ilan_grup =2 and ilan_ticari.onay != 1 and ilan_ticari.onay != 3 and ilan_ticari.ilan_tipi_id=ilan_tipi.id) as sayi  from ilan_tipi , ilan_ticari where ilan_tipi.tip=1 and ilan_tipi.grup_id=2  group by ilan_tipi.adi limit 20,10  ')->sor(10);
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
echo ' 
...
<li><A class=f2  href="index.php?action=arama&amp;tur='.$veri->id.'&amp;liste=1">'.$veri->adi.'</A>&nbsp;('.$veri->sayi.')</li>
 ...
 ?>    </td>
    <td align="left" valign="top" nowrap="nowrap">
       ...
       <?php 
 $vt->sql('select ilan_tipi.adi , ilan_tipi.id , (select count(ilan_ticari.id) from ilan_ticari where ilan_ticari.ilan_grup ="2" and ilan_ticari.onay != "1" and ilan_ticari.onay != "3" and ilan_ticari.ilan_tipi_id=ilan_tipi.id) as sayi  from ilan_tipi , ilan_ticari where ilan_tipi.tip="0" and ilan_tipi.grup_id="2"  group by ilan_tipi.adi limit 8,10  ')->sor(10);
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
echo ' 
<li><A class=f2  href="index.php?action=arama&amp;tur='.$veri->id.'&amp;liste=1">'.$veri->adi.'</A>&nbsp;('.$veri->sayi.')</li>
 ...
 ?>    </td>
    <td align="left" valign="top" nowrap="nowrap">
        <?php 
 $vt->sql('select ilan_tipi.adi , ilan_tipi.id , (select count(ilan_ticari.id) from ilan_ticari where ilan_ticari.ilan_grup ="2" and ilan_ticari.onay != "1" and ilan_ticari.onay != "3" and ilan_ticari.ilan_tipi_id=ilan_tipi.id) as sayi  from ilan_tipi , ilan_ticari where ilan_tipi.tip="0" and ilan_tipi.grup_id="2"  group by ilan_tipi.adi limit 18,10  ')->sor(10);
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
echo ' 
...
<li><A class=f2  href="index.php?action=arama&amp;tur='.$veri->id.'&amp;liste=1">'.$veri->adi.'</A>&nbsp;('.$veri->sayi.')</li>
 ...
 ?>    </td>
    <td align="left" valign="top" nowrap="nowrap">
        ...
        <?php 
 $vt->sql('select ilan_tipi.adi , ilan_tipi.id , (select count(ilan_ticari.id) from ilan_ticari where ilan_ticari.ilan_grup ="3" and ilan_ticari.onay != "1" and ilan_ticari.onay != "3" and ilan_ticari.ilan_tipi_id=ilan_tipi.id) as sayi  from ilan_tipi , ilan_ticari where ilan_tipi.tip="1" and ilan_tipi.grup_id="3"  group by ilan_tipi.adi limit 3,3  ')->sor(10);
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
echo ' 
<li><A class=f2  href="index.php?action=arama&amp;tur='.$veri->id.'&amp;liste=1">'.$veri->adi.'</A>&nbsp;('.$veri->sayi.')</li>
 ...
 ?>    </td>
    <td align="left" valign="top" nowrap="nowrap">
        ...
        <?php 
 $vt->sql('select ilan_tipi.adi , ilan_tipi.id , (select count(ilan_ticari.id) from ilan_ticari where ilan_ticari.ilan_grup ="3" and ilan_ticari.onay != "1" and ilan_ticari.onay != "3" and ilan_ticari.ilan_tipi_id=ilan_tipi.id) as sayi  from ilan_tipi , ilan_ticari where ilan_tipi.tip="1" and ilan_tipi.grup_id=3  group by ilan_tipi.adi limit 6,3  ')->sor(10);
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
echo ' 
...
<li><A class=f2  href="index.php?action=arama&amp;tur='.$veri->id.'&amp;liste=1">'.$veri->adi.'</A>&nbsp;('.$veri->sayi.')</li>
 ...
 $vt->sql('select ilan_tipi.adi , ilan_tipi.id , (select count(ilan_ticari.id) from ilan_ticari where ilan_ticari.ilan_grup ="3" and ilan_ticari.onay != "1" and ilan_ticari.onay != "3" and ilan_ticari.ilan_tipi_id=ilan_tipi.id) as sayi  from ilan_tipi , ilan_ticari where ilan_tipi.tip="0" and ilan_tipi.grup_id="3"  group by ilan_tipi.adi limit 3,5  ')->sor(10);
					  $veriler = $vt->alHepsi();
 foreach( $veriler as $veri )
{
echo ' 
...
/* 	SELECT uyeler.temiz_ad , uyeler.sirket , sehir.sehiradiUpper , count(ilan_ticari.id) as sayi  FROM  uyeler , sehir , ilan_ticari WHERE uyeler.il =  sehir.plaka and uyeler.uye_tipi='1' and ilan_ticari.uye_id = uyeler.id group by uyeler.id ORDER BY RAND() LIMIT 0,10 */
	$vt->sql("SELECT uyeler.temiz_ad , uyeler.sirket , sehir.sehiradiUpper , count(ilan_ticari.id) as sayi  FROM  uyeler , sehir , ilan_ticari WHERE uyeler.il =  sehir.plaka and uyeler.uye_tipi='1' group by uyeler.id ORDER BY RAND() LIMIT 0,10  ")->sor(10);
	$veriler = $vt->alHepsi();
	foreach($veriler as $veri) {
...
/* <li><a  href="http://'.$veri->temiz_ad.'.'.$site.'">'.$veri->sirket.'</a>&nbsp;'.$veri->sehiradiUpper.'&nbsp;('.$veri->sayi.')</li>	 */
	...
	?>    </td>
    <td>    <?php 
	$vt->sql("SELECT uyeler.temiz_ad , uyeler.sirket , sehir.sehiradiUpper , count(ilan_ticari.id) as sayi  FROM  uyeler , sehir , ilan_ticari WHERE uyeler.il =  sehir.plaka and uyeler.uye_tipi='1'  group by uyeler.id ORDER BY RAND() LIMIT 10,10  ")->sor(10);
	$veriler = $vt->alHepsi();
	foreach($veriler as $veri) {
		echo '<li><a  href="http://'.$veri->temiz_ad.'.'.$site.'" target="_blank">'.$veri->sirket.'</a>&nbsp;'.$veri->sehiradiUpper.'</li>';
	}
	...
	?></td>
    <td>    <?php 
	$vt->sql("SELECT uyeler.temiz_ad , uyeler.sirket , sehir.sehiradiUpper , count(ilan_ticari.id) as sayi  FROM  uyeler , sehir , ilan_ticari WHERE uyeler.il =  sehir.plaka and uyeler.uye_tipi='1'  group by uyeler.id ORDER BY RAND() LIMIT 20,10   ")->sor(10);
	$veriler = $vt->alHepsi();
	foreach($veriler as $veri) {
		echo '<li><a  href="http://'.$veri->temiz_ad.'.'.$site.'" target="_blank">'.$veri->sirket.'</a>&nbsp;'.$veri->sehiradiUpper.'</li>';
	}
