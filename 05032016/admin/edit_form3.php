...
////////////////////
//////////////////////////79
$vt->sql("update ilan_altyapi set  a1	='".temizle($_POST["d1"])."',a2='".temizle($_POST["d2"])."',	a3='".temizle($_POST["d3"])."',	a4='".temizle($_POST["d4"])."',	a5='".temizle($_POST["d5"])."',	a6='".temizle($_POST["d6"])."',	a7='".temizle($_POST["d7"])."',	a8='".temizle($_POST["d8"])."',	a9='".temizle($_POST["d9"])."' ,a10	='".temizle($_POST["d10"])."',a11='".temizle($_POST["d11"])."',	a12='".temizle($_POST["d12"])."',	a13='".temizle($_POST["d13"])."',	a14='".temizle($_POST["d14"])."',	a15='".temizle($_POST["d15"])."',	a16='".temizle($_POST["d16"])."',	a17='".temizle($_POST["d17"])."',	a18='".temizle($_POST["d18"])."',a19	='".temizle($_POST["d19"])."',a20='".temizle($_POST["d20"])."',	a21='".temizle($_POST["d21"])."',	a22='".temizle($_POST["d22"])."',	a23='".temizle($_POST["d23"])."',	a24='".temizle($_POST["d24"])."',	a25='".temizle($_POST["d25"])."',	a26='".temizle($_POST["d26"])."',	a27='".temizle($_POST["d27"])."' ,	a28='".temizle($_POST["d28"])."',	a29='".temizle($_POST["d29"])."',	a30='".temizle($_POST["d30"])."',	a31='".temizle($_POST["d31"])."',	a32='".temizle($_POST["d32"])."' where ilan_id= '".temizle($_GET["oid"])."' ");
...
if ($veri1->tapudurumu==$veri->id) {  $secilimi= "checked=\"checked\"";}
...
$secilimi="";
 ...
 ?></TD></TR>
        ...
        <TR>
          <TD noWrap>
            <DIV align=right><STRONG>Alt Yapý<BR>Yasal Durum</STRONG></DIV></TD>
          <TD>&nbsp;:&nbsp;</TD>
          <TD colSpan=2>
                    <?php 
...
if ($vt->alTek() != 0) {  $secilimi= "checked=\"checked\"";}
