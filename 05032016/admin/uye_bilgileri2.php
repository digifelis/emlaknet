...
// formu doðrularken kullanýlacak kurallar 
$fdo->kurallar(
...
$vt->sql('update `uyeler` set  sifre="'.$_POST['pass1'].'"  , isim_soyad = "'.temizle($_POST['name']).'"  , adres = "'.temizle($_POST['adresse']).'" , posta_kodu="'.temizle($_POST["plz"]).'",ilce="'.temizle($_POST["ort"]).'",il="'.temizle($_POST["region_bundesland"]).'",email="'.temizle($_POST["email"]).'",tel1="'.temizle($_POST["telefon"]).'",ceptel="'.temizle($_POST["handy"]).'" ,kod1="'.temizle($_POST["telefon_areacode"]).'",kod3="'.temizle($_POST["handy_areacode"]).'",web="'.temizle($_POST["url"]).'",fax="'.temizle($_POST["telefax"]).'" , temiz_ad="'.temizle($_POST["firma_adres"]).'" , onay="'.temizle($_POST["onay"]).'"   where id= "'.$_GET['id'].'"');
$vt->sor();
                  ...
                  align=center>
                    ...
                    <TR>
                      <TD colSpan=2><FONT size=4><STRONG>&#304;leti&#351;im 
                        Bilgileriniz</STRONG></FONT><BR><BR>&#304;leti&#351;im 
                        Bilgileriniz Formunda Yapmak &#304;stedi&#287;iniz De&#287;i&#351;iklikleri, 
                        A&#351;a&#287;&#305;daki Alanlar&#305; Kullanarak Ger&ccedil;ekle&#351;trebilirsiniz. 
                        <BR>
                     </TD></TR>
                    <TR>
                      <TD width=90><STRONG>Emlak&ccedil;&#305; ID:</STRONG></TD>
                      <TD><STRONG><?php echo $veri->id; ?></STRONG></TD></TR>
                    <TR>
                      <TD width=120 noWrap><STRONG>Kullan&#305;c&#305; &#304;smi:</STRONG> 
</TD>
                    ...
                    <TR>
                      ...
                      <TD><INPUT class=input value="<?php echo $veri->sifre; ?>" maxLength=64 size=30 
                        name=pass1></TD></TR>
                    <TR>
                      <TD vAlign=top noWrap><STRONG>&#350;ifre 
(Tekrar):</STRONG></TD>
                    ...
                    <TR>
                      ...
                      <TD><BR></TD></TR>
                <!--    <TR>
                      <TD vAlign=top noWrap><STRONG>Emlak&ccedil;&#305; 
                      Sayfan&#305;z:</STRONG></TD>
                      <TD>
                      <?php 
					  if($veri->onay == 1) { echo "Aktif"; } else {echo "Hen&uuml;z Aktif Degil";}
                      ?>
                      
                      </TD></TR> -->
                    <TR>
                      <th align="left">EmlakNet.Net &Uuml;ye Adresi :</th>
                      <TD><BR>
                        <label>
                          <input type="text" name="firma_adres" id="firma_adres"  value="<?php echo $veri->temiz_ad; ?>"/>
                        </label></TD></TR>
                    <TR>
                    ...
                    <TR>
                      ...
                      <TD><STRONG><?php echo $veri->sirket; ?></STRONG></TD></TR><!-- <TR>
			<TD><strong>Firma: </strong></TD>
		...
		foreach ($veriler1 as $veri1) {
         ...
         ?>    
                    ...
                    <TR>
                      ...
                      <TD><INPUT 
                    name=url class=input value="<?php echo $veri->web; ?>" size=40 maxLength=64></TD></TR>
                    <TR>
                      <TD></TD>
                      <TD><BR></TD></TR>
                    <TR>
