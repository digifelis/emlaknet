...
<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
    ...
    <INPUT value=douserdaten type=hidden  name=action>
                  ...
                  align=center>
                    <TBODY>
                    <TR>
                      <TD colSpan=2><FONT size=4><STRONG>Ýletiþim 
                        Bilgileriniz</STRONG></FONT><BR><BR>Ýletiþim 
                        Bilgileriniz Formunda Yapmak Ýstediðiniz Deðiþiklikleri, 
                        Aþaðýdaki Alanlarý Kullanarak Ger&ccedil;ekleþtrebilirsiniz. 
                        <BR>
     </TD></TR>
                    <TR>
                    ...
                    <TR>
                      <TD width=120 noWrap><STRONG>Kullanýcý Ýsmi:</STRONG> 
</TD>
                      <TD><?php echo $veri->kullanici_adi; ?></TD></TR>
                    <TR>
                      <TD><STRONG>Þifre:</STRONG></TD>
                      <TD><INPUT class=input maxLength=64 size=30 
                         name=pass1  value="<?php echo $veri->sifre; ?>"></TD></TR>
                    <TR>
                      <TD vAlign=top noWrap><STRONG>Þifre 
(Tekrar):</STRONG></TD>
                      <TD vAlign=top><INPUT class=input 
                        maxLength=64 size=30 name=pass2  value="<?php echo $veri->sifre; ?>"></TD></TR>
                    <TR>
                      <TD colSpan=2>( Þifrenizi deðiþtirmek istiyorsanýz 
                        yukarýdaki Þifre ve Þifre (Tekrar) b&ouml;l&uuml;mlerini 
                        kullanabilirsiniz. )<BR><BR></TD></TR>
                    <TR>
                      <TD></TD>
                      <TD><BR></TD></TR>
                 <!--   <TR>
                      <TD vAlign=top noWrap><STRONG>Emlak&ccedil;ý 
                      Sayfanýz:</STRONG></TD>
                      <TD>Hen&uuml;z Aktif Deðil</TD></TR> -->
                    <TR>
                      <TD><STRONG>Yetkili Kiþi:</STRONG></TD>
                    ...
                    <TR>
                      ...
                      <TD><INPUT class=input value="<?php echo $veri->posta_kodu; ?>" maxLength=5 size=5 
                        name=plz>&nbsp;&nbsp;/&nbsp;&nbsp;<STRONG>ÝL&Ccedil;E:</STRONG> 
                        &nbsp;&nbsp;<INPUT class=input value="<?php echo $veri->ilce; ?>" maxLength=64 
                        name=ort></TD></TR>
                    <TR>
                      <TD><STRONG>ÝL:</STRONG></TD>
         ...
         ?>     
                    ...
                    <TR>
                      <TD colSpan=2>
                        ...
                        <BR>Doldurulmasý gereken alanlarýn tamamý zorunlu 
                        alanlardýr.</DIV></TD></TR></TBODY></TABLE></FORM></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
<?php
}
?>